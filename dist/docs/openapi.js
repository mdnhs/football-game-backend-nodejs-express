    ...
    paths: {
        ...
        "/api/v1/admin/auth/login": {
            post: {
                ...
                description: "Issues an admin JWT (12h TTL by default). Returns admin id, email, role and permission list. Use the token as `Authorization: Bearer <token>` against all `/api/v1/admin/*` endpoints.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
